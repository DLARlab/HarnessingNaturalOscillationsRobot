...
#ifndef BOUNDING_LIP_H
#define BOUNDING_LIP_H
...
class State_Bounding_LIP : public FSMState{
public:
    State_Bounding_LIP(CtrlComponents *ctrlComp);
    ~State_Bounding_LIP();
    void enter(); 
    void run();
    void exit();
