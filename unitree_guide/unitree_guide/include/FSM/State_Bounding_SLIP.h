...
#ifndef BOUNDING_SLIP_H
#define BOUNDING_SLIP_H
...
class State_Bounding_SLIP : public FSMState{
public:
    State_Bounding_SLIP(CtrlComponents *ctrlComp);
    ~State_Bounding_SLIP();
    void enter(); 
    void run();
    void exit();
