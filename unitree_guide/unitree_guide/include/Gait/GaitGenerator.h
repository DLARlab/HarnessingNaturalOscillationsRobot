...
public:
    ...
    void setGaitExtra(Vec3 vCmdBody);
...
private:
    ...
    float cycloidYPosition(float startXY, float endXY, float phase, int i);
    float cycloidXPosition(float startXY, float endXY, float phase, int i);
    ...
    float _footDistance, _footExtension;
