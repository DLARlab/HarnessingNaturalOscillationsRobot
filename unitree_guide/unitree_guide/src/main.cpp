...
int main(int argc, char **argv)
{
    ...
    ctrlComp->waveGen = new WaveGenerator(0.26, 0.4, Vec4(0, 0, 0.5, 0.5));//ctrlComp->waveGen = new WaveGenerator(0.4, 0.55, Vec4(0, 0, 0.5, 0.5)); // Test gait for understanding WaveGenerator (0.4, 0.4, Vec4(0, 0, 0.55, 0.55)) very decent performance
