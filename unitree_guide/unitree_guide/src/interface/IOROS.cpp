...
{ 
    ...
    // if ( isnan(msg.linear_acceleration.z))
    // {
    // _lowState.imu.accelerometer[0] = 2;
    // _lowState.imu.accelerometer[1] = 0;
    // _lowState.imu.accelerometer[2] = 20;
    // }  
}
...
void IOROS::RRfootCallback(const geometry_msgs::WrenchStamped& msg)
{
    ...
    // std::cout << "eeForce" <<msg.wrench.force.x<< std::endl;
    // std::cout << "eeForce" <<_lowState.footForce[2]<< std::endl;
}
